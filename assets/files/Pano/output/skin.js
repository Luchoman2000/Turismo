...
function pano2vrSkin(player,base) {
	...
	this.addSkin=function() {
		...
		me.divSkin.appendChild(me._loading_text);
		el=me._loading_rectangle=document.createElement('div');
		el.ggId="Loading rectangle";
		el.ggParameter={ rx:0,ry:0,a:0,sx:1,sy:1 };
		el.ggVisible=true;
		...
		me._loading_rectangle.ggIsActive=function() {
			return false;
		}
		el.ggElementNodeId=function() {
			return player.getCurrentNode();
		}
		me._loading_rectangle.ggUpdatePosition=function (useTransition) {
		}
		me.divSkin.appendChild(me._loading_rectangle);
