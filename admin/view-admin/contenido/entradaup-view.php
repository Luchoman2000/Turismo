...
$us = $us->CtrEditarEntrada();
?>

<div class="d-flex flex-column" id="content-wrapper">
    <div id="content">
        <div class="container-fluid">
            <h1 class="text-dark mb-1" style="margin-top: 30px;">Actualizar atractivo turístico</h1>
        </div>
            ...
            <div class="row">
                <div class="col-md-12" style="margin-top: 30px;">
                    ...
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item active" aria-current="page">Actualizar atractivo</li>
                            <li class="breadcrumb-item"><a href="<?php echo  SERVERURL; ?>admin/listentrada">Lista de atractivos</a></li>
                        </ol>
                    </nav>
                    <div class="card shadow">
                        <div class="card-header py-3">
                            <p class="text-primary m-0 font-weight-bold">Actualizar atractivo</p>
                        </div>
                        <div class="card-body">
                            <form novalidate class="FormularioAjax" method="POST" data-form="update" enctype="multipart/form-data" autocomplete="off" action="<?php echo SERVERURL ?>admin/ajax-admin/entrada.ajax.php">
                                <input type="hidden" name="idAtr" value="<?php echo mainModel::encryption($us['id_atractivo_turistico']) ?>">
                                <!-- 1 Se ingresa el titulo -->
                                <h4 class="text-left">Título</h4>
                                <div class="form-group">
                                    <input type="text" class="form-control" name="tituloAtrUp" placeholder="Título" value="<?php echo $us['at_titulo'] ?>" />
                                </div>
                                <h4 class="text-left">Tipo</h4>
                                <div class="form-group">
                                    <select name="tipoAtrUp" class="browser-default custom-select">
                                        <option value="<?php echo $us['at_tipo'] ?>" selected><?php echo $us['at_tipo'] ?></option>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="form-group mb-4 ">
                                            ...
                                            <div class="row text-center text-lg-left" id="listImages">
                                                <div class="col-lg-3 col-md-4 col-6">
                                                    <a class="d-block mb-4 h-100">
                                                        <img name="imgP" class="imgP img-fluid img-thumbnail" src="<?php echo $us['at_imagen_path'] ?>" alt="">
                                                    </a>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <input type="hidden" value="<?php echo $us['at_imagen_path'] ?>" id="imagenVistaRuta" readonly name="imagenPathAtrUp" />


                                        <div>
                                            <button id="browseAtrUp" type="button" class="btn btn-primary browse">Subir imagen</button>
                                ...
                                <div class="container justify-content-center align-items-center mb-4" style="display: flex; flex-wrap: wrap; align-content:flex-start;">
                                    <div class="row text-center text-lg-left">
                                        ...
                                        foreach ($files as $file) {
                                            if ('panoramas/' . $file == $us['at_path_360']) {
                                                echo '<div class="col-lg-2">';
                                                // if (is_dir($file)) {
                                                // echo "<a href='$file'>$file</a><br>";
                                                echo '<div id="selectFolder' . $file . '" class="selectFolder card-header clearmargin clearpadding bg-info">
                                                        <span> ' . $file . '</span>
                                                </div>';
                                    ...
                                    <input type="hidden" value="<?php echo $us['at_path_360'] ?>" id="imagen360Ruta" readonly name="imagenPathAtr360Up" />
                                ...
                                <div class="form-group"><textarea rows="10" class="form-control" id="editor" name="contenidoAtrUp" maxlength="50">
