<div class="d-flex flex-column" id="content-wrapper">
    <div id="content">
        <div class="container-fluid">
            <h1 class="text-dark mb-1" style="margin-top: 30px;">Gestionar entradas</h1>
        </div>
        <div class="container-fluid" style="margin-top: 20px;">
            ...
            <div class="card shadow">
                <div class="card-header py-3">
                    <p class="text-primary m-0 font-weight-bold">Lista de atractivos turís  ticos </p>
                </div>
                <div class="card-body">
                    <div class="row">
